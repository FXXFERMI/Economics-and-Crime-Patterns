...
#### Save data ####
write_csv(merge_data, "data/analysis_data/analysis_data.csv") # save as .csv file
write_csv(raw_data_cpi, "data/analysis_data/analysis_data_CPI.csv") # save as .csv file
write_csv(vehicle_theft_wide, "data/analysis_data/analysis_data_Vehicle.csv") # save as .csv file
write_csv(vehicle_theft_summary, "data/analysis_data/draft_analysis_data_Vehicle.csv") # save as .csv file
...
#### Save data ####
write_csv(transposed_data, "data/analysis_data/analysis_data.csv") # save as .csv file