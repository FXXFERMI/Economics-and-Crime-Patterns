...
The @tbl-CPIData shows a sample dataset of CPI from @statscanCPI2023, it shows all the CPI categories in the dataset, while only have 3 observations. The @tbl-AutoData shows a sample dataset of Vehicle Thetfs Dataset from @torontoPoliceAutoTheft2023.
